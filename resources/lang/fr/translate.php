...
return [
    ...
    'Leave_taken_vs_remaining' => 'Congés pris vs restants',
    ...
    'No_Shift_Today' => 'jour non travaillé',
    'Not_Started' => 'Pas commencé',
    'Office_Shift' => 'Période de travail',
    ...
    'Due' => 'Date de fin',
    'Home_Office' => 'Télétravail',
    "From home" => "Télétravail",
    'Home_Office_List' => 'Liste des bureaux à domicile',
    'Personal_Goals' => 'Projets assignés',
    ...
    "Taken" => "Pris",
    "Remaining" => "Restants",
    "Kenarh - The Best HRM & Project Management" => "Kenarh - La meilleure gestion de ressources humaines et de projets",
    "approved" => "Approuvé",
    "pending" => "En attente",
    "rejected" => "Refusé",
    "Next" => "Suivant",
    "Previous" => "Précédent",
    "Search..." => "Rechercher...",
    "Showing _START_ to _END_ of _TOTAL_ entries" => "Affichage _START_ à _END_ de _TOTAL_ entrées",
    "No matching records found" => "Aucune donnée disponible",
    "filtered from _MAX_ total entries" => "filtré de _MAX_ entrées totales",
    "Last" => "Dernier",
    "EXPORT" => "EXPORTER",
    ...
    'OK' => 'OK',
    'Cancel' => 'Annuler',
    'Sorry, no matching options' => 'Désolé, aucune option correspondante',
