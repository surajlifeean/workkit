...
return [
    ...
    'Home_Office_List' => 'قائمة المكاتب المنزلية',
    ...
    "Logout" => "تسجيل خروج", "Hi" => "أهلاً",
    "Taken" => "مأخوذ",
    "Remaining" => "متبقي",
    "Kenarh - The Best HRM & Project Management" => "كنارة - أفضل إدارة للموارد البشرية وإدارة المشاريع",
    "pending" => "قيد الانتظار",
    "approved" => "موافقة",
    "Next" => "التالي",
    "Previous" => "سابق",
    "Search..." => "يبحث...",
    "Showing _START_ to _END_ of _TOTAL_ entries" => "عرض _START_ ل _END_ ل _TOTAL_ إدخالات",
    "No matching records found" => "لا تتوافر بيانات",
    "filtered from _MAX_ total entries" => "تمت تصفيته من _MAX_ إجمالي الإدخالات",
    "Last" => "آخر",
    "EXPORT" => "يصدّر",
    ...
    'Present' => 'حاضر','Week ends' => 'نهاية الأسبوع','print' => 'طباعة',
    ...
    'OK' => 'موافق',
    'Cancel' => 'إلغاء',
    'Sorry, no matching options' => 'عذرًا، لا توجد خيارات متطابقة',
    "full_time" => "وقت كامل",
    "part_time" => "بدوام جزئي",
    "self_employed" => "عامل حر",
    "freelance" => "حرّ",
    "internship" => "تدريب",
    "apprenticeship" => "تعلم مهنة",
    "seasonal" => "عقد موسمي",
    ...
    'plan_limit_exceeded' => 'تجاوزت الحد الخاص بالخطة أو ليس لديك خطة نشطة. لا يمكن إنشاء المزيد من الموظفين.',
    'plan_limit_exceeded_user' => 'تجاوزت الحد الخاص بالخطة أو ليس لديك خطة نشطة. لا يمكن إنشاء المزيد من المستخدمين.',
];
