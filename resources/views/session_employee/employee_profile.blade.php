            ...
            <div class="tab-pane fade" id="nav-basic" role="tabpanel" aria-labelledby="nav-basic-tab">
                ...
                <div class="row">
                    ...
                    <form @submit.prevent="Update_Employee_Basic_Info()">
                        ...
                        <div class="row mt-3">
                            <div class="col-lg-6">
                                <button type="submit" class="btn btn-{{$setting->theme_color}}" :disabled="SubmitProcessingBasic">
                                    {{ __('translate.Submit') }}
                                </button>
                    ...
                    <div class="col-md-12">
                        <div class="text-left">
                            <div class="text-left bg-transparent">
                                <a class="btn btn-{{$setting->theme_color}} btn-md m-2" @click="New_Document"><i class="i-Add text-white mr-2"></i>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form @submit.prevent="edit_mode_document?Update_document():Create_document()">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-6">
                                                    <button type="submit" class="btn btn-{{$setting->theme_color}}" :disabled="Submit_Processing_document">
                                                        {{ __('translate.Submit') }}
                                                    </button>
            ...
            <div class="tab-pane fade" id="nav-bank" role="tabpanel" aria-labelledby="nav-bank-tab">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="text-left">
                            <div class="text-left bg-transparent">
                                <a class="btn btn-{{$setting->theme_color}} btn-md m-2" @click="New_Account"><i class="i-Add text-white mr-2"></i>{{ __('translate.Add_Account') }}</a>
                            </div>
                            <div class="table-responsive">
                                <table id="ul-contact-list" class="display table data_datatable">
                                    <thead>
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form @submit.prevent="edit_mode_account?Update_Account():Create_Account()">
                                            ...
                                            <div class="row mt-3">
                                                ...
                                                <div class="col-md-6">
                                                    <button type="submit" class="btn btn-{{$setting->theme_color}}" :disabled="Submit_Processing_Bank">
                                                        {{ __('translate.Submit') }}
                                                    </button>
