!(function (e, t) {
    ...
    var lang_name = current_lang == 'en' ? "English" : (current_lang == 'fr' ? 'French' : 'Arabic');
    
    var full_month_name = current_lang == 'en' ? ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"] : (
        current_lang == 'fr' ? ["Janvier", "Février", "Mars", "Avril", "Mai", "Juin", "Juillet", "Août", "Septembre", "Octobre", "Novembre", "Décembre"]
        : ["يناير", "فبراير", "مارس", "إبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"]
        );

    var shortM = current_lang == 'en' ? ["Jan", "Feb", "Mar", "Apr", "May", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"] : (
        current_lang == 'fr' ? ["Janv", "Fév", "Mar", "Avr", "Mai", "Juin", "Juil", "Août", "Sep", "Oct", "Nov", "Déc"]
        : ["يناير", "فبراير", "مارس", "إبريل", "مايو", "يونيو", "يوليو", "أغسطس", "سبتمبر", "أكتوبر", "نوفمبر", "ديسمبر"]
        );

    var day_name = current_lang == 'en' ? ["Sun", "Mon", "Tue", "Wed", "Thu", "Fri", "Sat"]: (
        current_lang == 'fr' ? ["Dim", "Lun", "Mar", "Mer", "Jeu", "Ven", "Sam"]
    ...
    var n = new ((function () {
            ...
            lang_name, full_month_name, shortM, day_name 
        ),
        s = {
            useUtc: !1,
